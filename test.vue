    ...
    <div class="add-group">
      ...
      <div v-if="this.isAdminUser" class="body scroll">
        ...
        >
            ...
            <a-form-model-item :validate-status="validationRole" :help="validationHelpForRole">
              <template #label>
            ...
            <a-form-model-item :validate-status="validationPermission" :help="validationHelpForPermission" v-if="form.selectedRoles.length > 0" ref="admin">
              <template #label>
